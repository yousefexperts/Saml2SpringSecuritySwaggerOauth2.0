...
public class SoapClientConfig {
    ...
    @Bean
    public KeyStoreCallbackHandler securityCallbackHandlerClient() throws Exception {
    ...
    public Wss4jSecurityInterceptor responseSecurityInterceptor() throws IOException, Exception {
        ...
        securityInterceptor.setValidationCallbackHandler(securityCallbackHandlerClient());
