...
import com.experts.core.biller.statemachine.api.rovo.awsxray.config.settings.HttpClientSettings;
import com.experts.core.biller.statemachine.api.rovo.awsxray.utils.CustomTruststoreParameters;
...
public class HttpClientSpringConfig {
    ...
    private class AWSXRayEnrichedHttpComponent extends HttpComponent {
        ...
        protected HttpClientBuilder createHttpClientBuilder(final String uri, final Map<String, Object> parameters,
           ...
           // IntrospectionSupport.extractProperties(clientBuilder, httpClientOptions);
